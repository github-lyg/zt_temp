...
class Excel_EweiShopV2Model 
{
	...
	public function export($list, $params = array()) 
	{
		...
		$excel = new PHPExcel();
		$excel->getProperties()->setCreator((empty($data['name']) ? '祥云科技' : $data['name']))->setLastModifiedBy((empty($data['name']) ? '祥云科技' : $data['name']))->setTitle('Office 2007 XLSX Test Document')->setSubject('Office 2007 XLSX Test Document')->setDescription('Test document for Office 2007 XLSX, generated using PHP classes.')->setKeywords('office 2007 openxml php')->setCategory('report file');
	...
	public function temp($title, $columns = array()) 
	{
		...
		require_once IA_ROOT . '/framework/library/phpexcel/PHPExcel.php';
		$excel = new PHPExcel();
		$excel->getProperties()->setCreator('祥云科技')->setLastModifiedBy('祥云科技')->setTitle('Office 2007 XLSX Test Document')->setSubject('Office 2007 XLSX Test Document')->setDescription('Test document for Office 2007 XLSX, generated using PHP classes.')->setKeywords('office 2007 openxml php')->setCategory('report file');
		$sheet = $excel->setActiveSheetIndex(0);
		$rownum = 1;
