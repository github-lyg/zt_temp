...
-- ----------------------------
-- Table structure for `ims_ewei_shop_coupon_record`
-- ----------------------------
DROP TABLE IF EXISTS `ims_ewei_shop_coupon_record`;
CREATE TABLE `ims_ewei_shop_coupon_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `coupon_id_2` (`coupon_id`) USING BTREE,
...
-- ----------------------------
-- Records of ims_ewei_shop_coupon_record
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ims_ewei_shop_order_query`
-- ----------------------------
DROP TABLE IF EXISTS `ims_ewei_shop_order_query`;
CREATE TABLE `ims_ewei_shop_order_query` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`) USING BTREE,
  KEY `idx_openid` (`out_trade_no`) USING BTREE,
  KEY `idx_shareid` (`transaction_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of ims_ewei_shop_order_query
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ims_ewei_shop_order_withdraw_apply`
-- ----------------------------
DROP TABLE IF EXISTS `ims_ewei_shop_order_withdraw_apply`;
CREATE TABLE `ims_ewei_shop_order_withdraw_apply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_ewei_shop_order_withdraw_apply
-- ----------------------------
...
CREATE TABLE `ims_ewei_shop_perm_log` (
  ...
  KEY `idx_createtime` (`createtime`),
  KEY `idx_uniacid` (`uniacid`)
) ENGINE=MyISAM AUTO_INCREMENT=1577 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
INSERT INTO `ims_ewei_shop_plugin` VALUES ('40', '44', 'pc', 'tool', 'PC端', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/pc.jpg', '', '0', '0', '1');
...
INSERT INTO `ims_ewei_shop_plugin` VALUES ('45', '48', 'app', 'help', '小程序', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/app.jpg', '', '0', '0', '1');
INSERT INTO `ims_ewei_shop_plugin` VALUES ('46', '49', 'merchmanage', 'tool', '多商户手机端', '2.0', '二开', '1', '../addons/ewei_shopv2/static/images/merchmanage.jpg', '多商手机登录，管理自己商品订单发货等，操作简洁。', '0', '0', '0');
INSERT INTO `ims_ewei_shop_plugin` VALUES ('47', '50', 'cycelbuy', 'biz', '周期购', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/cycelbuy.jpg', '', '0', '0', '1');
INSERT INTO `ims_ewei_shop_plugin` VALUES ('48', '51', 'polyapi', 'tool', '进销存-网店管家', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/polyapi.jpg', '', '0', '0', '1');
INSERT INTO `ims_ewei_shop_plugin` VALUES ('49', '52', 'dividend', 'biz', '团队分红', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/dividend.jpg', '', '0', '0', '1');
INSERT INTO `ims_ewei_shop_plugin` VALUES ('50', '53', 'membercard', 'sale', '付费会员卡', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/membercard.png', '', '0', '0', '1');
-- ----------------------------
