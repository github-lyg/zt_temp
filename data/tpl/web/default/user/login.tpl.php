...
<head>
    ...
    <style type="text/css">
        ...
        .login-container {
            ...
            background: url("<?php  echo $_W['siteroot'];?>/web/resource/images/bg_szk.png") no-repeat 50%; 
        ...
        .login-input>img{width: 14px;height: 14px;margin: 0 10px;}
        ...
        .ivu-input{border:0;height: 60px!important;line-height: 60px!important;}
        .ivu-input:focus{border-color: rgba(255,255,255,0);box-shadow: 0 0 0 0 rgba(255,255,255,0);}
    </style>
</head>
            ...
            <div class="login-mainbox">
                ...
                <div class="login-wrap">
                    <div class="login-header-text">
                        <h1 style="color: #054dca;font-size: 17px;">帐号登录</h1>
                    </div>
                    <form class="ivu-form ivu-form-label-right">
                        <div class="input-box ivu-form-item ivu-form-item-required">
                            <div class="ivu-form-item-content">
                                <div class="login-input ivu-input-wrapper ivu-input-type">
                                    <img src="<?php  echo $_W['siteroot'];?>/web/resource/images/bg_szk1.png" alt="">
                        ...
                        <div class="input-box ivu-form-item ivu-form-item-required">
                            <div class="ivu-form-item-content">
                                <div class="login-input ivu-input-wrapper ivu-input-type">
                                    <img src="<?php  echo $_W['siteroot'];?>/web/resource/images/bg_szk2.png" alt="">
                                    <i class="ivu-icon ivu-icon-load-c ivu-load-loop ivu-input-icon ivu-input-icon-validate"></i>
					...
					<?php  if(!$_W['siteclose'] && $setting['register']['open']) { ?>
						...
						<a href="<?php  echo url('user/register');?>" class="color-default" style="color: #054dca;">立即注册</a>
						<?php  } ?>
