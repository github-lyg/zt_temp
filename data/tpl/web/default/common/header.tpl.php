		...
		<div class="container <?php  if(!empty($frames['section']['platform_module_menu']['plugin_menu'])) { ?>plugin-head<?php  } ?>">
			...
			<div class="collapse navbar-collapse">
				...
				<ul class="nav navbar-nav  navbar-left">
					...
					<li <?php  if(FRAME == $nav['name'] && !defined('IN_MODULE')||!empty($platform)&& $nav['name']=='platform'||!empty($module_top)&& $nav['name']=='module' ) { ?> class="active" <?php  } ?>>
				...
				<ul class="nav navbar-nav navbar-right ">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu color-gray" role="menu">
							...
							<li><a href="<?php  echo url('cloud/shuimujian');?>" target="_blank" style="color:red;"><i class="wi wi-update color-gray"></i> 更新功能</a></li>
