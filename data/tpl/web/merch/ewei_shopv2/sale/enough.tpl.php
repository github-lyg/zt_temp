...
<div class='page-header'>
    <span>当前位置： <span class="text-primary">满额立减设置</span></span>
</div>
<div class="page-content">
    <form id="dataform"    <?php if(mcv('sale.enough')) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate">
        <div class="form-group">
            <div class="col-sm-12">
            <?php if(mcv('sale.enough')) { ?>
                <div class='input-group recharge-item fixmore-input-group'>
        ...
        <div class="form-group">
            <div class="col-sm-12">
                ...
                <?php  if(is_array($data['enoughs'])) { foreach($data['enoughs'] as $item) { ?>
                    <div class="input-group fixmore-input-group recharge-item" style="margin-top:5px">
                        <span class="input-group-addon">单笔订单满</span>
...
<script language='javascript'>
	...
	function addConsumeItem(){
		var html= '<div class="input-group fixmore-input-group recharge-item"  style="margin-top:5px">';
