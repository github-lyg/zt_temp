    ...
    <form action="" method="post">
        ...
        <div class="page-table-header">
            ...
            <div class="btn-group">
                ...
                <?php  } ?>
                <?php if(cv('creditshop.adv.delete')) { ?>
        ...
        <table class="table table-responsive table-hover" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php if(cv('creditshop.adv.edit')) { ?>
                            <a href='javascript:;' data-toggle='ajaxEdit' data-href="<?php  echo webUrl('creditshop/adv/displayorder',array('id'=>$row['id']))?>" ><?php  echo $row['displayorder'];?></a>
                        <?php  } else { ?>
                    ...
                    <td>
                        ...
                        <td style="text-align:left;">
                            <?php if(cv('creditshop.adv.view|creditshop.adv.edit')) { ?>
                                <a href="<?php  echo webUrl('creditshop/adv/edit', array('id' => $row['id']))?>" class="btn btn-default btn-sm btn-op btn-operation">
                                    <span data-toggle="tooltip" data-placement="top" title="" data-original-title=" <?php if(cv('creditshop.adv.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>">
                                   <?php if(cv('creditshop.adv.edit')) { ?>
