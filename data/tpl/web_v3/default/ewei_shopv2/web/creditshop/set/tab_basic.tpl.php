...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <label class='radio radio-inline'>
            <input type='radio' value='0' name='data[set_realname]'  <?php  if($data['set_realname']==0) { ?>checked<?php  } ?> /> 是
        </label>
        <label class='radio radio-inline'>
            <input type='radio' value='1' name='data[set_realname]' <?php  if($data['set_realname']==1) { ?>checked<?php  } ?> /> 否
        </label>
        <?php  } else { ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('creditshop.set.edit')) { ?>
        <label class='radio radio-inline'>
            <input type='radio' value='0' name='data[set_mobile]'  <?php  if($data['set_mobile']==0) { ?>checked<?php  } ?> /> 是
        </label>
        <label class='radio radio-inline'>
            <input type='radio' value='1' name='data[set_mobile]' <?php  if($data['set_mobile']==1) { ?>checked<?php  } ?> /> 否
        </label>
        <?php  } else { ?>
...
<div class="form-group">
    <label class="col-lg control-label">线下兑换关键词</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('creditshop.set.edit')) { ?>
...
<div class="form-group">
    <label class="col-lg control-label">发送者名称</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('creditshop.set.edit')) { ?>
...
<div class="form-group">
    <label class="col-lg control-label">红包祝福语</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('creditshop.set.edit')) { ?>
...
<div class="form-group">
    <label class="col-lg control-label">会员中心积分兑换按钮</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('creditshop.set.edit')) { ?>
        <label class='radio radio-inline'>
...
<div class="form-group">
    <label class="col-lg control-label">积分说明页面</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('creditshop.set.edit')) { ?>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('creditshop.set.edit')) { ?>
        <textarea name="data[share_desc]" class="form-control" rows="5"><?php  echo $data['share_desc'];?></textarea>
        <?php  } else { ?>
...
<div class="form-group">
    <label class="col-lg control-label">重要说明</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('creditshop.set.edit')) { ?>
        <textarea name="data[importantdetail]" class="form-control" placeholder="全局重要说明，不填则不显示" rows="5"><?php  echo $data['importantdetail'];?></textarea>
        <?php  } else { ?>
