...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <div class="form-control-static js-clip text-primary" data-href="<?php  echo $item['openid'];?>"><?php  echo $item['openid'];?></div>
    </div>
</div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <div class="form-control-static"><?php  echo $item['uname'];?></div>
        </div>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <?php if( ce('merch.user' ,$item) ) { ?>
        <textarea name="desc" class="form-control textarea"><?php  echo $item['desc'];?></textarea>
        <?php  } else { ?>
...
<div class="col-sm-8">
    <?php if(cv('merch.reg.detail')) { ?>
    <textarea name="reason" class="form-control textarea"><?php  echo $item['reason'];?></textarea>
    <?php  } else { ?>
