...
<div class="page-content">
    <div class="page-sub-toolbar">
		 ...
		 <?php if(cv('globonus.level.add')) { ?>
                            <a class='btn btn-primary btn-sm' data-toggle='ajaxModal'
                               href="<?php  echo webUrl('globonus/level/add')?>"><i class="fa fa-plus"></i> 添加新等级</a>
		 <?php  } ?>
    ...
    <table class="table table-responsive table-hover" style="text-align: left">
        ...
        <tr>
            ...
            <th style='width:160px;'>冻结金额</th>
            <th style='width:160px;'>分红比例</th>
            <th>升级条件</th>
        ...
        <td><?php  echo $row['froze_amount'];?></td>
        ...
        <td>
            ...
            <a class='btn btn-default btn-sm btn-op btn-operation' data-toggle='ajaxModal'
               href="<?php  echo webUrl('globonus/level/edit', array('id' => $row['id']))?>"
               title="<?php if(cv('globonus.level.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?>">
                                <span data-toggle="tooltip" data-placement="top"
                                      data-original-title="<?php if(cv('globonus.level.edit')) { ?>编辑<?php  } else { ?>查看<?php  } ?>">
                                    <?php if(cv('globonus.level.edit')) { ?>
            ...
            <a class='btn btn-default btn-sm btn-op btn-operation' data-toggle='ajaxRemove'
               href="<?php  echo webUrl('globonus/level/delete', array('id' => $row['id']))?>" data-confirm="确认删除此等级吗？">
