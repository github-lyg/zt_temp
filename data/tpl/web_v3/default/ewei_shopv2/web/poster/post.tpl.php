    ...
    <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">
        ...
        <input type="hidden" name="tab" id='tab' value="<?php  echo $_GPC['tab'];?>" />
           ...
           <ul class="nav nav-arrow-next nav-tabs" id="myTab">
                    ...
                    <li class="type4 <?php  if($_GPC['tab']=='reward') { ?>active<?php  } ?>" <?php  if($item['type']!=4) { ?>style='display:none'<?php  } ?>><a href="#tab_reward">奖励</a></li>
                    <li class="type4 <?php  if($_GPC['tab']=='resp') { ?>active<?php  } ?>" <?php  if($item['type']!=4) { ?>style='display:none'<?php  } ?>><a href="#tab_resp">推送</a></li>
                    <li class="type4 <?php  if($_GPC['tab']=='notice') { ?>active<?php  } ?>" <?php  if($item['type']!=4) { ?>style='display:none'<?php  } ?>><a href="#tab_notice">通知</a></li>
                    <li class="type4 <?php  if($_GPC['tab']=='commission') { ?>active<?php  } ?>" <?php  if($item['type']!=4) { ?>style='display:none'<?php  } ?>><a href="#tab_commission">分销</a></li>
                </ul> 
     
                <div class="tab-content">
                    <div class="tab-pane  <?php  if($_GPC['tab']=='basic' || empty($_GPC['tab'])) { ?>active<?php  } ?>" id="tab_basic"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('poster/post/basic', TEMPLATE_INCLUDEPATH)) : (include template('poster/post/basic', TEMPLATE_INCLUDEPATH));?></div>
                    <div class="tab-pane  <?php  if($_GPC['tab']=='design') { ?>active<?php  } ?>" id="tab_design"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('poster/post/design', TEMPLATE_INCLUDEPATH)) : (include template('poster/post/design', TEMPLATE_INCLUDEPATH));?></div>
                    <div class="tab-pane  <?php  if($_GPC['tab']=='resp') { ?>active<?php  } ?>" id="tab_resp" ><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('poster/post/resp', TEMPLATE_INCLUDEPATH)) : (include template('poster/post/resp', TEMPLATE_INCLUDEPATH));?></div>
                    
                    
                    <div class="tab-pane <?php  if($_GPC['tab']=='reward') { ?>active<?php  } ?>" id="tab_reward"  ><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('poster/post/reward', TEMPLATE_INCLUDEPATH)) : (include template('poster/post/reward', TEMPLATE_INCLUDEPATH));?></div>
                    <div class="tab-pane <?php  if($_GPC['tab']=='notice') { ?>active<?php  } ?>" id="tab_notice" ><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('poster/post/notice', TEMPLATE_INCLUDEPATH)) : (include template('poster/post/notice', TEMPLATE_INCLUDEPATH));?></div>
                    <div class="tab-pane <?php  if($_GPC['tab']=='commission') { ?>active<?php  } ?>" id="tab_commission"  ><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('poster/post/commission', TEMPLATE_INCLUDEPATH)) : (include template('poster/post/commission', TEMPLATE_INCLUDEPATH));?></div>
            </div>
