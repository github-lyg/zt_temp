            ...
            <div class="input-group">
                ...
                <span class="input-group-select">
                    <select name='searchtime'  class='form-control'   style="width:100px;padding:0 5px;"  id="searchtime">
                        ...
                        <option value='finish' <?php  if($_GPC['searchtime']=='finish') { ?>selected<?php  } ?>>核销时间</option>
                    </select>
                </span>
                ...
                <span class="input-group-select">
                    ...
                    <select name='searchtype'  class='form-control  input-sm select-md'    >
                        <option value='all' <?php  if($_GPC['searchtype']=='all') { ?>selected<?php  } ?>>全部类型</option>
                        <option value='store' <?php  if($_GPC['searchtype']=='store') { ?>selected<?php  } ?>>门店核销订单</option>
                        <option value='trade' <?php  if($_GPC['searchtype']=='trade') { ?>selected<?php  } ?>>门店预约订单</option>
                        <option value='mall' <?php  if($_GPC['searchtype']=='mall') { ?>selected<?php  } ?>>商城订单</option>
                    </select>
                    <?php  } else { ?>
