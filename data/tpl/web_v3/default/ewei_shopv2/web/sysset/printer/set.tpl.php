...
<div class="page-content">
    <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label class="col-lg control-label">多商户订单</label>
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('sysset.printer.set')) { ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9 col-xs-12">
                <?php if(cv('sysset.printer.set')) { ?>
                <label class="radio-inline"><input type="radio" name="printer_recharge" value="0" <?php  if(empty($data['printer_recharge'])) { ?>checked<?php  } ?>> 不打印</label>
                <label class="radio-inline"><input type="radio" name="printer_recharge" value="1" <?php  if(!empty($data['printer_recharge'])) { ?>checked<?php  } ?>> 打印</label>
                <?php  } else { ?>
                <div class='form-control-static'><?php  if(empty($data['printer_recharge'])) { ?>不打印<?php  } else { ?>打印<?php  } ?></div>
                <?php  } ?>
            </div>
        </div>
        <div class="form-group">
