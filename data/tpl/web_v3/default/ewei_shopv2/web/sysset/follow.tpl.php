...
<div class="page-header">当前位置：<span class="text-primary">关注及分享设置</span></div>
       ...
       <form action="" method="post" class="form-horizontal  form-validate" enctype="multipart/form-data" >
           ...
           <div class="form-group">
               ...
               <div class="col-sm-9 col-xs-12">
                   ...
                   <?php  echo tpl_form_field_image2('data[icon]', $data['icon']);?>
           ...
           <div class="form-group">
               ...
               <div class="col-sm-9 col-xs-12">
                   <?php if(cv('sysset.follow.edit')) { ?>
                   <textarea style="height:100px;" name="data[desc]" class="form-control" rows="5"><?php  echo $data['desc'];?></textarea>
                   <?php  } else { ?>
                   <textarea style="height:100px;display: none" name="data[desc]" class="form-control" rows="5"><?php  echo $data['desc'];?></textarea>
           ...
           <div class="form-group">
               <label class="col-lg control-label">商品详情分享</label>
               <div class="col-sm-9">
           ...
           <div class="form-group">
               <label class="col-lg control-label">商品详情分享文字</label>
               <div class="col-sm-9 col-xs-12">
                   <?php if(cv('sysset.follow.edit')) { ?>
                   <textarea style="height:100px;" name="data[goods_detail_text]" class="form-control" rows="5"><?php  echo $data['goods_detail_text'];?></textarea>
                   <span class="help-block">商品详情页面按钮 按下 弹出文字 默认文字: <br/><span class="text-danger">请点击右上角<br/>通过【发送给朋友】<br/>邀请好友购买</span></span>
                   <?php  } else { ?>
                   <textarea style="height:100px;display: none" name="data[goods_detail_text]" class="form-control" rows="5"><?php  echo $data['goods_detail_text'];?></textarea>
                   <div class='form-control-static'><?php  echo $data['desc'];?></div>
                   <?php  } ?>
               </div>
           </div>
