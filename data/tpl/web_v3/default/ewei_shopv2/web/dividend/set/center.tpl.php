...
<div class="form-group">
    <label class="col-lg control-label">会员中心排行榜入口</label>
    <div class="col-sm-9 col-xs-12">
        <div class="row">
            <?php if(cv('dividend.set.edit')) { ?>
            <div class="col-sm-3">
                <label class="radio-inline">
                    <input type="radio" name="data[dividendrank]" value="1" <?php  if($data['dividendrank'] ==1) { ?> checked="checked"<?php  } ?> /> 是
                </label>
                <label class="radio-inline">
                    <input type="radio"  name="data[dividendrank]" value="0" <?php  if(empty($data['dividendrank'])) { ?> checked="checked"<?php  } ?> /> 否
                </label>
            </div>
            <?php  } else { ?>
            <?php  } ?>
