    ...
    <div class="tabs-container tab-goods">
        ...
        <div class="tabs-left">
            ...
            <ul class="nav nav-tabs" id="myTab">
                ...
                <li <?php  if($_GPC['tab']=='tab_dividend') { ?>class="active"<?php  } ?>><a href="#tab_dividend">团队分红</a></li>

                <?php  } ?>

                <?php  if(p('globonus')) { ?>

                <li <?php  if($_GPC['tab']=='tab_globonus') { ?>class="active"<?php  } ?>><a href="#tab_globonus">全民股东</a></li>
            ...
            <div class="tab-content  ">
                ...
                <div class="tab-pane <?php  if($_GPC['tab']=='tab_dividend') { ?>active<?php  } ?>" id="tab_dividend"> <div class="panel-body"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('dividend/goods', TEMPLATE_INCLUDEPATH)) : (include template('dividend/goods', TEMPLATE_INCLUDEPATH));?></div></div>

                <?php  } ?>

                <?php  if(p('globonus')) { ?>

                <div class="tab-pane <?php  if($_GPC['tab']=='tab_globonus') { ?>active<?php  } ?>" id="tab_globonus"> <div class="panel-body"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('globonus/goods', TEMPLATE_INCLUDEPATH)) : (include template('globonus/goods', TEMPLATE_INCLUDEPATH));?></div></div>
