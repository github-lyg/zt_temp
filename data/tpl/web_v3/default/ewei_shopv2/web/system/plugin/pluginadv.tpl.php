...
<div class="page-content">
    ...
    <form action="" method="post">
        ...
        <div class="page-table-header">
            <input type="checkbox">
            <div class="btn-group">
                <button class="btn btn-default btn-sm btn-operation" type="button" data-toggle='batch' data-href="<?php  echo webUrl('system/plugin/pluginadv/enabled',array('enabled'=>1))?>">
                    <i class='icow icow-xianshi'></i> 显示
                </button>
                <button class="btn btn-default btn-sm btn-operation" type="button" data-toggle='batch'  data-href="<?php  echo webUrl('system/plugin/pluginadv/enabled',array('enabled'=>0))?>">
                    <i class='icow icow-yincang'></i> 隐藏
                </button>
                <button class="btn btn-default btn-sm btn-operation" type="button" data-toggle='batch-remove' data-confirm="确认要删除?" data-href="<?php  echo webUrl('system/plugin/pluginadv/delete')?>">
        ...
        <table class="table table-responsive table-hover" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                            <a href='javascript:;' data-toggle='ajaxEdit' data-href="<?php  echo webUrl('system/plugin/pluginadv/displayorder',array('id'=>$row['id']))?>" ><?php  echo $row['displayorder'];?></a>
                    </td>
                    ...
                    <td>
                        ...
                        <td style="text-align:left;">
                                <a href="<?php  echo webUrl('system/plugin/pluginadv/edit', array('id' => $row['id']))?>" class="btn btn-default btn-sm btn-op btn-operation">
                                    <span data-toggle="tooltip" data-placement="top" title="" data-original-title="修改">
                                        <i class="icow icow-bianji2"></i>
                                     </span>
                                </a>
                                <a data-toggle='ajaxRemove' href="<?php  echo webUrl('system/plugin/pluginadv/delete', array('id' => $row['id']))?>"class="btn btn-default btn-sm btn-op btn-operation" data-confirm='确认要删除此幻灯片吗?'>
