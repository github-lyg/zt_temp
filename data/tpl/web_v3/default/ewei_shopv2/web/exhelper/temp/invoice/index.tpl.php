...
<div class="page-content">
	<form action="./index.php" method="get" class="form-horizontal" plugins="form">
		...
		<div class="page-toolbar">
			<div class="col-sm-4">
				<?php if(cv('exhelper.temp.invoice.add')) { ?>
	...
	<form action="" method="post">
		<?php if(cv('exhelper.temp.invoice.delete')) { ?>
					...
					<tr>
						...
						<td>
							<span class='defaults label <?php  if($row['isdefault']==1) { ?>label-primary<?php  } else { ?>label-default<?php  } ?>'
							  <?php if(cv('exhelper.temp.invoice.setdefault')) { ?>
						...
						<td>
							<?php if(cv('exhelper.temp.invoice.edit')) { ?>
