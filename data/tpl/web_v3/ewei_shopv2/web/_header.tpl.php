...
<div class="wb-header" style="position: fixed;">
        ...
        <li class="dropdown <?php  if($system['merch']) { ?>auto<?php  } ?> ellipsis">
            ...
            <ul class="dropdown-menu" <?php  if($system['routes']['0']=='system') { ?>style="width:100%;left:0"<?php  } ?>>
                ...
                <?php  if(is_array($system['right_menu']['menu_items'])) { foreach($system['right_menu']['menu_items'] as $right_menu_item) { ?>
                    ...
                    <?php  } ?>
                <?php  } } ?>
                <li <?php  if($system['merch']) { ?> style="display: none" <?php  } ?>><a href="./index.php?c=user&a=logout&amp">退出系统</a></li>
                <?php  } else { ?>
                <li style="margin-top: 0;height: 50px;line-height: 50px;<?php  if($system['merch']) { ?>display: none<?php  } ?>"><a href="index.php?c=site&a=entry&m=ewei_shopv2&do=web&r=plugins">返回应用</a></li>
                <?php  } ?>
            </ul>
        </li>
    ...
    <div class="wb-nav <?php  if(!empty($system['foldnav'])) { ?>fold<?php  } ?>">
        ...
        <ul id="navheight">
                <li><a href="./index.php?c=site&a=entry&m=ewei_shopv2&do=web"><h2>数据概况</h2></a></li>
    ...
    <?php  if(!$no_right) { ?>
        <div class="wb-panel <?php  if(empty($system['foldpanel'])) { ?>in<?php  } ?>">
            <div class="panel-group" id="panel-accordion">
                <?php if(mcv('order.list.status1|order.list.status4')) { ?>
                ...
                <?php  } ?>
                <?php  if(!$system['merch']) { ?>
                    <?php if(mcv('commission.apply.view1|commission.apply.view2')) { ?>
                    <div class="panel panel-default">
                ...
                <!--<div class="panel panel-default">-->
                    <!--<div class="panel-heading">-->
                        <!--<h4> <i class="icow icow-lingdang"></i> <a href="./index.php?c=account&a=post&uniacid=1&acid=1" ">编辑公众号 <i class="systips"></i></a></h4>-->
                    <!--</div>-->
                <!--</div>-->
                <!--<div class="panel panel-default">-->
                    <!--<div class="panel-heading">-->
                        <!--<h4> <i class="icow icow-lingdang"></i> <a href="http://www.renren.com/web/index.php?c=site&a=entry&m=ewei_shopv2&do=web&r=sysset.payset" >支付方式 <i class="systips"></i></a></h4>-->
                    <!--</div>-->
                <!--</div>-->
            </div>
        </div>
