...
<style>
    ...
    .card-list-content .content .title i{
        font-size: 0.85rem;
        margin-right: 0.5rem;
        color: #fff;
        opacity: 0.9;
    ...
    <a class="fui-cell-group city_express external" style="display: none;" href="<?php  echo mobileUrl('shop/cityexpress/map')?>">
        <div class="fui-cell">
            <div class="fui-cell-text" style="line-height: 1.1rem">
                <span ><i class="icon icon-huoche" style="background: #fff;color: #20c94d;font-size: 1.1rem;
                line-height: 1.1rem;float: left;display: inline-block;margin-right: 0.2rem" ></i ></span>
...
<div class="fui-cell-group">
    ...
    <?php  if($show_card&&!empty($my_card_list['list'])) { ?>
    <div class="fui-cell" id='selectCard'>
        <div class='fui-cell-label' style="width: 4.5rem">会员卡优惠</div>
        <div class="fui-cell-info"></div>
        <div class='fui-cell-remark'>
            <img id="cardloading" src="../addons/ewei_shopv2/static/images/loading.gif" style="vertical-align: middle;display: none;" width="20" alt=""/>
            <?php  if($my_card_list) { ?>
    ...
    <div class="fui-cell taskcut"  style="display: none">
        ...
        <input type="hidden" id='cardtaskcut' value="<?php  echo number_format($taskcut,2)?>" />
    </div>
...
<div class="fui-cell" id="showdispatchprice">
    <div class="fui-cell-label"  style="width: 5.5rem">运费</div>
    <div class="fui-cell-info"></div>
...
<div class="fui-navbar order-create-checkout">
    <a href="javascript:;" class="nav-item total">
        <p style="color: #000">
            需付：<span class="text-danger  bigprice">&yen; <span class="<?php  if(!$packageid && empty($exchangeOrder)) { ?>totalprice<?php  } ?> total-packageid">
            <?php  if(!empty($exchangeOrder)) { ?><span class="exchange-withpostage"><?php  echo $exchangerealprice;?></span>
            <span class="exchange-withoutpostage" style="display: none"><?php  echo $exchangeprice;?></span><?php  } else if($taskgoodsprice) { ?><?php  echo $taskgoodsprice;?><?php  } else { ?><?php  echo price_format($realprice,2)?><?php  } ?></span></span>
        </p>
    </a>
...
<?php  if($show_card) { ?>
<?php (!empty($this) && $this instanceof WeModuleSite) ? (include $this->template('membercard/picker', TEMPLATE_INCLUDEPATH)) : (include template('membercard/picker', TEMPLATE_INCLUDEPATH));?>
<?php  } ?>
