...
<div class='fui-page fui-page-current'>
        ...
        <div class="fui-cell-group">
            <div class="fui-cell fui-cell-textarea">
                ...
                <div class="fui-cell-info">
                    <textarea rows="3" placeholder="请输入商品民称" id="title"><?php  echo $item['title'];?></textarea>
                </div>
            </div>
            <div class="fui-cell">
    ...
    <?php (!empty($this) && $this instanceof WeModuleSite) ? (include $this->template('merchmanage/_tpl/goods_params', TEMPLATE_INCLUDEPATH)) : (include template('merchmanage/_tpl/goods_params', TEMPLATE_INCLUDEPATH));?>
