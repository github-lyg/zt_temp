        ...
        <div class="fui-cell-group">
            ...
            <div class="fui-cell">
                ...
                <div class="fui-cell-info">
                    ...
                    <select class="fui-input" id="express" <?php  if($item['city_express_state']==1) { ?>disabled="disabled"<?php  } ?> >

                        <option value=""><?php  if($item['city_express_state']==0) { ?>其他快递<?php  } else { ?>同城配送<?php  } ?></option>
            ...
            <?php  if($item['city_express_state']==0) { ?>
            ...
            <div class="fui-cell">
                ...
                <div class="fui-cell-info">
                    ...
                    <!--<input type="text" placeholder="请输入快递单号" class="fui-input" value="<?php  echo $item['expresssn'];?>" id="expresssn" <?php  if($item['city_express_state']==1) { ?>disabled="disabled"<?php  } ?>>-->
            ...
            <div class="fui-cell-group">
                ...
                <div class="fui-cell ">
                    ...
                    <div class="fui-cell-info">
                        ...
                        <input type="checkbox" class="fui-switch fui-switch-small fui-switch-success pull-right toggle" data-toggle-check="true" data-show="parcel" id="sendtype" <?php  if($item['sendtype']>0) { ?>checked="checked" disabled="disabled"<?php  } ?> <?php  if($item['city_express_state']==1) { ?>disabled="disabled"<?php  } ?> />
